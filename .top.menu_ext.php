...
if ($GLOBALS["USER"]->IsAuthorized() && CModule::IncludeModule("socialnetwork") )
{
	...
	{	if (in_array(12, $USER->GetUserGroupArray())){   // <-------- #efgnluyhjm#
			$arMenuB24[] = array(
...
//if (!CSite::InGroup(array(12)) && CSite::InGroup(array(25, 24, 1))){
	$arMenuB24[] = array(
		"Карта", 
		SITE_DIR."map/index.php", 
		Array(), 
		Array(), 
		"" 
	);
...
if (CModule::IncludeModule("intranet") && CIntranetUtils::IsExternalMailAvailable() && in_array(12, $USER->GetUserGroupArray())) //<----- #uykuyhkuyh# 
{
	$arMenuB24[] = array(
