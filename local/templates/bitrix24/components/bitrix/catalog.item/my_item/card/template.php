...
<div class="product-item">
	<a  title="<?=$imgTitle?>" class="product-item-image-wrapper" data-entity="image-wrapper">
...
//echo("<pre>"); print_r($id); echo("</pre>");
	?>
	<div class="button_product_add_basket">
        <div class="fields string">
            <input type="text" name="count_product" value="1" size="20" class="fields string">
        </div>
		<span class="add_product_in_basket" class="webform-small-button">
			<span class="webform-small-button-text" id="<?=$id?>">Положить в корзину</span>
		</span>
	</div>
</div>